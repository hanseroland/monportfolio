...
const AboutInfo = 
{
    ...
    description: "Je suis NGUEMA NTOUGOU Hanse Roland Parfait, un developpeur Full Stack junior talentueux. "+
                  "Ayant un vif intérêt à collaborer pour créer des solutions numériques qui résolvent les problèmes du monde réel. \n\n"+
                 "Actuellement en Master 1 à l'École Superieure de Technologie et de Management (ESTM, Dakar-Sénégal), "+
                 "J'ai travaillé dans plusieurs projets et technologies tout en acquérant des compétennces en HTML, CSS, "+
                 "JavaScript, React.js et React Native, Express.js Node.js.  \n\n"+
                 "Je comprends les concepts d'applications à page unique, d'applictions Web progressives et d'API Rest.",
      ...
      <Container>
        <ColumnLeft>
          ...
          <motion.h2
            ...
            transition={{ duration: 1 }}
          >
            DEVELOPPEUR FULLSTACK JUNIOR REACT.JS & REACT NATIVE 
          </motion.h2>
          <motion.h6
            variants={fadeLeft}
            initial='hidden'
            ...
            transition={{ duration: 1 }}
          >
            Je suis un développeur Fullstack Junior spécialisé en React JS pour le développement web et 
            React Native pour le développement mobile avec des compétences en photoshop
          </motion.h6>
          <Button
